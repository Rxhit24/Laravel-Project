<template>
    <div class="py-5 px-8">
        ...
        <form v-else @submit.prevent="submitSurvey" class="container mx-auo">
            ...
            <div v-if="surveyFinished" class="fixed top-5 left-5 animate-fade-in-down w-[600]px py-8 px-6 bg-emerald-400 text-white w-[600]px mx-auto">
                <div class="text-xl mb-3 font-semibold">
                    Thank you Participating in survey
                </div>
                <button @click="submitAnotherResponse" 
                type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent
