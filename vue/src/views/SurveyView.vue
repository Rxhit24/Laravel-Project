    ...
    <PageLayout>
        <template v-slot:header>
            <div class="flex items-center justify-between">
                ...
                <button v-if="route.params.id" @click="deleteSurvey" type="button" class="flex justify-center rounded-md border border-red-500 p-1 text-red-500 hover:bg-red-500 hover:text-white">
        ...
        <form v-else @submit.prevent="saveSurvey" class="animate-fade-in-down">
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <!-- Survey fields start -->
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6 bg-gray-200">
                    <!-- image upload -->
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" v-model="model.title" autocomplete="survey_title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 
            ...
            <div class="px-4 py-5 bg-gray-200 space-y-6 sm:p-6">
                <h3 class="text-2xl font-semibold flex items-center justify-between ">
                    ...
                    <button v-if="model.questions" type="button" @click="addQuestion()"
                ...
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    <button type="submit" class=" px-4 rounded-md border bg-green-500 text-white">
                        Save
                    </button>
                </div>
            </div>
...
//watch to current survey data change and when this happens we upadte local model.value also
watch(
...
function saveSurvey() {
    store.dispatch("saveSurvey", model.value).then(({ data }) => {
        store.commit('notify', {
            type: "success" , 
            message: "Surevy Saved Succesfully"
        })
        router.push({
            name: "SurveyView",
